...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { cpu: @computer.cpu, hdd: @computer.hdd, ram: @computer.ram, utag: @computer.utag } }, as: :json
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { cpu: @computer.cpu, hdd: @computer.hdd, ram: @computer.ram, utag: @computer.utag } }, as: :json
    assert_response 200
  end
